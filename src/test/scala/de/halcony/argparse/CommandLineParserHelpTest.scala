...
class CommandLineParserHelpTest extends AnyFlatSpec with should.Matchers {

  "the help message" should "be correctly formed for optionals" in {
  ...
  it should "be correctly formed for positionals" in {
    val parser = Parser("test", "test")
  ...
  it should "be correctly formed for flags" in {
    val parser = Parser("test", "test")
  ...
  it should "be correctly formated in mixture" in {
    val parser = Parser("test", "test")
      .addOptional("optional1", 'o', "opt1", identity[String], Some("first"), "this is the first optional")
      .addOptional("optional2", 'c', "opt2", identity[String], Some("second"), "this is the second optional")
      .addPositional("first", identity[String], "this is a positional")
  ...
  it should "be correctly formed with subparsers available" in {
    val parser = Parser("test", "test")
      .addSubparser {
        Parser("sub", "sub")
      }
